...
const mockKudos = {
    ...
    message: 'Great work!',
    createdAt: new Date(),
    sender: { id: 'u1', name: 'Sender', avatar: 'a1.png', role: 'Member', teamId: 't1' },
    receiver: { id: 'u2', name: 'Receiver', avatar: 'a2.png', role: 'Member', teamId: 't1' },
    likes: [{ userId: 'u3' }],
};
    ...
    describe('create', () => {
        it('should create and return formatted kudos', async () => {
            ...
            const result = await service.create({
                senderId: 'u1', receiverId: 'u2', coreValue: 'Kaizen', message: 'Great!',
            });
