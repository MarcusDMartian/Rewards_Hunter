...
const mockIdea = {
    ...
    createdAt: new Date(),
    updatedAt: new Date(),
    creator: { id: 'u1', name: 'User', avatar: 'avatar.png', role: 'Member', teamId: 't1' },
    votes: [{ voterId: 'u2' }],
    comments: [{
        id: 'c1', userId: 'u2', text: 'Great idea',
        createdAt: new Date(),
...
describe('IdeasService', () => {
    ...
    describe('create', () => {
        it('should create and return idea', async () => {
            ...
            const result = await service.create({
                title: 'Test', problem: 'P', proposal: 'S', impact: 'Cost', creatorId: 'u1',
            });
    ...
    describe('addComment', () => {
        it('should create comment and return formatted data', async () => {
            mockPrisma.kaizenComment.create.mockResolvedValue({
                id: 'c1', ideaId: 'idea1', userId: 'u1', text: 'Nice!',
    ...
    describe('updateStatus', () => {
        it('should update idea status', async () => {
            mockPrisma.kaizenIdea.update.mockResolvedValue({ id: 'idea1', status: 'Approved' });
