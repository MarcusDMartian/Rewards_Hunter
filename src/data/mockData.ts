// ============================================
// MOCK DATA - Separated from system constants
// ============================================
// This file contains all mock/seed data used for demo purposes.
// When integrating with the real backend, this file can be removed entirely.

import { User, Mission, KaizenIdea, Kudos, Reward, PointTransaction, ActivityItem, Organization, JoinRequest } from '../types';
